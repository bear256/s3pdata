...
public class KeywordsMentionedMostMappingService {
	...
	public String get(String platform, String topic, String pnScope, int days) {
		...
		List<KeywordMentionedMostMapping> list = new ArrayList<>();
		for (DocEntity doc : docs) {
			list.add(JSON.parseObject(doc.getJson(), KeywordMentionedMostMapping.class));
		}
