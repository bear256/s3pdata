...
public class MentionedMostServiceListByUserVolService {
	...
	public String get(String platform, String topic, String pnScope) {
		...
		List<MentionedMostServiceByUserVol> list = new ArrayList<>();
		for (DocEntity doc : docs) {
			list.add(JSON.parseObject(doc.getJson(), MentionedMostServiceByUserVol.class));
		}
