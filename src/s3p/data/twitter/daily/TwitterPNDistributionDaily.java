...
public class TwitterPNDistributionDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByTopic, String tableName, DateTime dt, String topic) {
		if (ENDPOINT.equals(endpoint)) {
			new TwitterPNDistributionDaily().merge(listByTopic).save(tableName, dt, topic);
		}
	}

	public TwitterPNDistributionDaily merge(List<DocEntity> listByTopic) {
