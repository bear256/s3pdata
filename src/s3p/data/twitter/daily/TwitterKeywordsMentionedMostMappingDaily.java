...
public class TwitterKeywordsMentionedMostMappingDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new TwitterKeywordsMentionedMostMappingDaily().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public TwitterKeywordsMentionedMostMappingDaily merge(List<DocEntity> listByPN) {
