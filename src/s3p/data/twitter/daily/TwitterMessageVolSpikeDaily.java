...
public class TwitterMessageVolSpikeDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new TwitterMessageVolSpikeDaily().detect(listByPN, pn).save(tableName, dt, topic, pn);
		}
	}

	public TwitterMessageVolSpikeDaily detect(List<DocEntity> listByPN, String pn) {
