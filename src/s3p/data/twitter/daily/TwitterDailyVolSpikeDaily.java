...
/*
 * Do the same thing at the class VolSpikesMonthly
 */

public class TwitterDailyVolSpikeDaily {
...
//	private List<DailyVolSpike> list = new ArrayList<DailyVolSpike>();
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic) {
		if (ENDPOINT.equals(endpoint)) {
			new TwitterDailyVolSpikeDaily().detectMerge(listByPN).save(tableName, dt, topic);
		}
	}

	public TwitterDailyVolSpikeDaily detectMerge(List<DocEntity> listByPN) {
