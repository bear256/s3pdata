...
public class TwitterMentionedMostServiceListDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new TwitterMentionedMostServiceListDaily().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public TwitterMentionedMostServiceListDaily merge(List<DocEntity> listByPN) {
