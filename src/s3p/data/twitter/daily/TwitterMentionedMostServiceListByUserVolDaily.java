...
public class TwitterMentionedMostServiceListByUserVolDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new TwitterMentionedMostServiceListByUserVolDaily().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public TwitterMentionedMostServiceListByUserVolDaily merge(List<DocEntity> listByPN) {
