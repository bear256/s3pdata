...
public class TwitterUserVolSpikeDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new TwitterUserVolSpikeDaily().detect(listByPN, pn).save(tableName, dt, topic, pn);
		}
	}

	public TwitterUserVolSpikeDaily detect(List<DocEntity> listByPN, String pn) {
