...
public class TwitterDailyVolSpikeWeekly implements Weekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic) {
		if (ENDPOINT.equals(endpoint)) {
			new TwitterDailyVolSpikeWeekly().merge(listByPN).save(tableName, dt, topic, "ALL");
		}
	}

	public TwitterDailyVolSpikeWeekly merge(List<DocEntity> listByPN) {
