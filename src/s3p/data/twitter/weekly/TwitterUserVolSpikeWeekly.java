...
public class TwitterUserVolSpikeWeekly implements Weekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new TwitterUserVolSpikeWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public TwitterUserVolSpikeWeekly merge(List<DocEntity> listByPN) {
