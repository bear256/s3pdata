...
public class TwitterInfluenceVolSpikeWeekly implements Weekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new TwitterInfluenceVolSpikeWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public TwitterInfluenceVolSpikeWeekly merge(List<DocEntity> listByPN) {
