...
public class TwitterDailyInfluenceWeekly implements Weekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new TwitterDailyInfluenceWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public TwitterDailyInfluenceWeekly merge(List<DocEntity> listByPN) {
