...
public class TwitterKeywordsMentionedMostMappingWeekly implements Weekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new TwitterKeywordsMentionedMostMappingWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public TwitterKeywordsMentionedMostMappingWeekly merge(List<DocEntity> listByPN) {
