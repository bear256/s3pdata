...
public class TwitterMentionedMostServiceListWeekly implements Weekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new TwitterMentionedMostServiceListWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}
	
	public TwitterMentionedMostServiceListWeekly merge(List<DocEntity> listByPN) {
