...
public class TwitterPNDistributionWeekly implements Weekly {
	...
	public static void run(String endpoint, List<DocEntity> listByTopic, String tableName, DateTime dt, String topic) {
		if (ENDPOINT.equals(endpoint)) {
			new TwitterPNDistributionWeekly().merge(listByTopic).save(tableName, dt, topic, "ALL");
		}
	}

	public TwitterPNDistributionWeekly merge(List<DocEntity> listByTopic) {
