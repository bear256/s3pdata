...
public class StackForumKeywordsMentionedMostMappingWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new StackForumKeywordsMentionedMostMappingWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public StackForumKeywordsMentionedMostMappingWeekly merge(List<DocEntity> listByPN) {
