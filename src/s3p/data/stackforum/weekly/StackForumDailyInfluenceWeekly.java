...
public class StackForumDailyInfluenceWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new StackForumDailyInfluenceWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public StackForumDailyInfluenceWeekly merge(List<DocEntity> listByPN) {
