...
public class StackForumMentionedMostServiceListWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new StackForumMentionedMostServiceListWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}
	
	public StackForumMentionedMostServiceListWeekly merge(List<DocEntity> listByPN) {
