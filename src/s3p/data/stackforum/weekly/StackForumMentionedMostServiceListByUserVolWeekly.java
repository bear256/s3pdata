...
public class StackForumMentionedMostServiceListByUserVolWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new StackForumMentionedMostServiceListByUserVolWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public StackForumMentionedMostServiceListByUserVolWeekly merge(List<DocEntity> listByPN) {
