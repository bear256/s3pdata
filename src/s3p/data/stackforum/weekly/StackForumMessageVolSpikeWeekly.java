...
public class StackForumMessageVolSpikeWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new StackForumMessageVolSpikeWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public StackForumMessageVolSpikeWeekly merge(List<DocEntity> listByPN) {
