...
public class StackForumUserVolSpikeWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new StackForumUserVolSpikeWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public StackForumUserVolSpikeWeekly merge(List<DocEntity> listByPN) {
