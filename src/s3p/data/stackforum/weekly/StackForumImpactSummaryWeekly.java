...
public class StackForumImpactSummaryWeekly {

	private static final String ENDPOINT = Endpoint.IMPACTSUMMARY;

	private ImpactSummary impactSummary;

	public StackForumImpactSummaryWeekly gen(String platform, String topic, DateTime dt) {
		...
		// RegionDistribution mostnegfrom = genMostPNFrom(platform, topic,
		// Sentiment.NEG, dt);
		// RegionDistribution mostposifrom = genMostPNFrom(platform, topic,
		// Sentiment.POSI, dt);
		...
		impactSummary = new ImpactSummary(influenceofusers, joinedusers, mentionedservicecount, mostdislikedservice,
				mostlikedservice, new RegionDistribution(), new RegionDistribution(), new RegionOfUsers(), vocinsights);
		return this;
	}
