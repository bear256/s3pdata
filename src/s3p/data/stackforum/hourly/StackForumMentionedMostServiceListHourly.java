...
public class StackForumMentionedMostServiceListHourly {
	...
	public StackForumMentionedMostServiceListHourly groupByService(String topic, List<StackForum> listByPN) {
		for (StackForum stackForum : listByPN) {
			...
			List<String> services = ServiceNameUtils.match4StackForum(topic, text);
