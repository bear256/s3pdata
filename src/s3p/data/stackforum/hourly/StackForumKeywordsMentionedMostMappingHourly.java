...
public class StackForumKeywordsMentionedMostMappingHourly {
	...
	public StackForumKeywordsMentionedMostMappingHourly groupByKeyword(List<StackForum> listByPN) {
		for (StackForum stackForum : listByPN) {
			Owner owner = stackForum.getOwner();
			if (owner == null)
				continue;
			String userId = stackForum.userId();
