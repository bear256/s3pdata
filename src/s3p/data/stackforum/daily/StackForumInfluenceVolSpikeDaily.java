...
public class StackForumInfluenceVolSpikeDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new StackForumInfluenceVolSpikeDaily().detect(listByPN, pn).save(tableName, dt, topic, pn);
		}
	}

	public StackForumInfluenceVolSpikeDaily detect(List<DocEntity> listByPN, String pn) {
