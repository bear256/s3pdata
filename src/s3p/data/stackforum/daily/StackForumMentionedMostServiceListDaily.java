...
public class StackForumMentionedMostServiceListDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new StackForumMentionedMostServiceListDaily().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}
	
	public StackForumMentionedMostServiceListDaily merge(List<DocEntity> listByPN) {
