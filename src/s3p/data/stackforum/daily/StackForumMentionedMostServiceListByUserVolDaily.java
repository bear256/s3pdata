...
public class StackForumMentionedMostServiceListByUserVolDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new StackForumMentionedMostServiceListByUserVolDaily().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public StackForumMentionedMostServiceListByUserVolDaily merge(List<DocEntity> listByPN) {
