...
public class StackForumDailyInfluenceDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new StackForumDailyInfluenceDaily().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public StackForumDailyInfluenceDaily merge(List<DocEntity> listByPN) {
