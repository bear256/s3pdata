...
public class StackForumPNDistributionDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByTopic, String tableName, DateTime dt, String topic) {
		if (ENDPOINT.equals(endpoint)) {
			new StackForumPNDistributionDaily().merge(listByTopic).save(tableName, dt, topic);
		}
	}

	public StackForumPNDistributionDaily merge(List<DocEntity> listByTopic) {
