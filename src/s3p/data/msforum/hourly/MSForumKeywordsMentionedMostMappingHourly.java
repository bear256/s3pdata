...
public class MSForumKeywordsMentionedMostMappingHourly {
	...
	public MSForumKeywordsMentionedMostMappingHourly groupByKeyword(List<MSForum> listByPN) {
		for (MSForum msForum : listByPN) {
			String userId = msForum.userId();
			String text = msForum.getBody();
