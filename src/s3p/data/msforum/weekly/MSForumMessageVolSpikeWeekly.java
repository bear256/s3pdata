...
public class MSForumMessageVolSpikeWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new MSForumMessageVolSpikeWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public MSForumMessageVolSpikeWeekly merge(List<DocEntity> listByPN) {
