...
public class MSForumPNDistributionWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByTopic, String tableName, DateTime dt, String topic) {
		if (ENDPOINT.equals(endpoint)) {
			new MSForumPNDistributionWeekly().merge(listByTopic).save(tableName, dt, topic, "ALL");
		}
	}

	public MSForumPNDistributionWeekly merge(List<DocEntity> listByTopic) {
