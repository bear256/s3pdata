...
public class MSForumImpactSummaryWeekly {

	private static final String ENDPOINT = Endpoint.IMPACTSUMMARY;

	private ImpactSummary impactSummary;

	public MSForumImpactSummaryWeekly gen(String platform, String topic, DateTime dt) {
		...
		// UserRegionVolSpike mostnegfrom = genMostPNFrom(platform, topic,
		// Sentiment.NEG, dt);
		// UserRegionVolSpike mostposifrom = genMostPNFrom(platform, topic,
		// Sentiment.POSI, dt);
