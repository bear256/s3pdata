...
public class MSForumMentionedMostServiceListWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new MSForumMentionedMostServiceListWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}
	
	public MSForumMentionedMostServiceListWeekly merge(List<DocEntity> listByPN) {
