...
public class MSForumDailyVolSpikeWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic) {
		if (ENDPOINT.equals(endpoint)) {
			new MSForumDailyVolSpikeWeekly().merge(listByPN).save(tableName, dt, topic, "ALL");
		}
	}

	public MSForumDailyVolSpikeWeekly merge(List<DocEntity> listByPN) {
