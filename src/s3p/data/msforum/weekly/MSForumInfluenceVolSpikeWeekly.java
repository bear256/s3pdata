...
public class MSForumInfluenceVolSpikeWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new MSForumInfluenceVolSpikeWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public MSForumInfluenceVolSpikeWeekly merge(List<DocEntity> listByPN) {
