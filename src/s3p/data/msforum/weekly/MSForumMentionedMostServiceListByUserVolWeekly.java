...
public class MSForumMentionedMostServiceListByUserVolWeekly {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new MSForumMentionedMostServiceListByUserVolWeekly().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public MSForumMentionedMostServiceListByUserVolWeekly merge(List<DocEntity> listByPN) {
