...
public class MSForumDailyInfluenceDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new MSForumDailyInfluenceDaily().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public MSForumDailyInfluenceDaily merge(List<DocEntity> listByPN) {
