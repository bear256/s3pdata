...
public class MSForumKeywordsMentionedMostMappingDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new MSForumKeywordsMentionedMostMappingDaily().merge(listByPN).save(tableName, dt, topic, pn);
		}
	}

	public MSForumKeywordsMentionedMostMappingDaily merge(List<DocEntity> listByPN) {
