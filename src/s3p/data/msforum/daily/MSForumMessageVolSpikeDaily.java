...
public class MSForumMessageVolSpikeDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new MSForumMessageVolSpikeDaily().detect(listByPN, pn).save(tableName, dt, topic, pn);
		}
	}

	public MSForumMessageVolSpikeDaily detect(List<DocEntity> listByPN, String pn) {
