...
public class MSForumInfluenceVolSpikeDaily {
	...
	public static void run(String endpoint, List<DocEntity> listByPN, String tableName, DateTime dt, String topic,
		...
		if (ENDPOINT.equals(endpoint)) {
			new MSForumInfluenceVolSpikeDaily().detect(listByPN, pn).save(tableName, dt, topic, pn);
		}
	}

	public MSForumInfluenceVolSpikeDaily detect(List<DocEntity> listByPN, String pn) {
